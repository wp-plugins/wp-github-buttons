 ...
 * @remark      
 */
final class WPGitHubButtons_Registry extends WPGitHubButtons_Registry_Base {
	        
    /**
     * The plugin option key used for the options table.
     */
    static public $aOptionKeys = array(
        'main'    => 'wp_github_buttons',
    );
     ...
     */
    const HOOK_SLUG = 'wp_github_buttons';
     ...
     */
    const TEXT_DOMAIN                = 'wp-github-buttons';
     ...
     * 
     * Example:  WPGitHubButtons_Registry::getPluginURL( 'asset/css/meta_box.css' );
     * @since       0.0.1
...
new WPGitHubButtons_Bootstrap(
    ...
    WPGitHubButtons_Registry::HOOK_SLUG    // hook prefix    
);
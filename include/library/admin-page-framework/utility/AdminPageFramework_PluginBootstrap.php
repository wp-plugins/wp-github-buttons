 ...
 */
abstract class WPGitHubButtons_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('WPGitHubButtons_AdminPageFramework_RegisterClasses')) {
            return;
        }
        new WPGitHubButtons_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }

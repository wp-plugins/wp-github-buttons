 ...
 */
abstract class WPGitHubButtons_AdminPageFramework_Widget extends WPGitHubButtons_AdminPageFramework_Widget_Controller {
    ...
    public function __construct($sWidgetTitle, $aWidgetArguments = array(), $sCapability = 'edit_theme_options', $sTextDomain = 'admin-page-framework') {
        ...
        $this->oProp = new WPGitHubButtons_AdminPageFramework_Property_Widget($this, null, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);

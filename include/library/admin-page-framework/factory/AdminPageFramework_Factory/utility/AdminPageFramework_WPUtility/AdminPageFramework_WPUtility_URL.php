 ...
 */
class WPGitHubButtons_AdminPageFramework_WPUtility_URL extends WPGitHubButtons_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(WPGitHubButtons_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(WPGitHubButtons_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $sRelativePath = WPGitHubButtons_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);

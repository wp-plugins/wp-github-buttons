 ...
 */
abstract class WPGitHubButtons_AdminPageFramework_Factory_Model extends WPGitHubButtons_AdminPageFramework_Factory_Router {
    ...
    protected function _loadFieldTypeDefinitions() {
        if (empty(self::$_aFieldTypeDefinitions)) {
            self::$_aFieldTypeDefinitions = WPGitHubButtons_AdminPageFramework_FieldTypeRegistration::register(array(), $this->oProp->sClassName, $this->oMsg);
        }
    ...
    protected function _registerField(array $aField) {
        WPGitHubButtons_AdminPageFramework_FieldTypeRegistration::_setFieldResources($aField, $this->oProp, $this->oResource);
        if ($aField['help']) {
    ...
    protected function _isValidationErrors() {
        if (isset($GLOBALS['aWPGitHubButtons_AdminPageFramework']['aFieldErrors']) && $GLOBALS['aWPGitHubButtons_AdminPageFramework']['aFieldErrors']) {
            return true;
        }
    ...
    public function _replyToSaveFieldErrors() {
        if (!isset($GLOBALS['aWPGitHubButtons_AdminPageFramework']['aFieldErrors'])) {
            return;
        }
        $this->oUtil->setTransient("apf_field_erros_" . get_current_user_id(), $GLOBALS['aWPGitHubButtons_AdminPageFramework']['aFieldErrors'], 300);
    }
    public function _replyToSaveNotices() {
        if (!isset($GLOBALS['aWPGitHubButtons_AdminPageFramework']['aNotices'])) {
            return;
        }
        if (empty($GLOBALS['aWPGitHubButtons_AdminPageFramework']['aNotices'])) {
            return;
        }
        $this->oUtil->setTransient('apf_notices_' . get_current_user_id(), $GLOBALS['aWPGitHubButtons_AdminPageFramework']['aNotices']);
    }

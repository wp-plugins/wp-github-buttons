 ...
 */
class WPGitHubButtons_AdminPageFramework_FieldType_checkbox extends WPGitHubButtons_AdminPageFramework_FieldType {
...
CSSRULES;
    ...
    private function _getEachCheckboxOutput(array $aField, $sKey, $sLabel) {
        $_oCheckbox = new WPGitHubButtons_AdminPageFramework_Input_checkbox($aField['attributes']);

 ...
 */
abstract class WPGitHubButtons_AdminPageFramework_FieldType_Base extends WPGitHubButtons_AdminPageFramework_WPUtility {
    ...
    protected function geFieldOutput(array $aField) {
        ...
        $_oField = new WPGitHubButtons_AdminPageFramework_FormField($aField, $_aOptions, $_oCaller->getFieldErrors(), $_oCaller->oProp->aFieldTypeDefinitions, $_oCaller->oMsg, $_oCaller->oProp->aFieldCallbacks);
    ...
    protected function enqueueMediaUploader() {
        ...
        if (function_exists('wp_enqueue_media')) {
            new WPGitHubButtons_AdminPageFramework_Script_MediaUploader($this->oMsg);
        } else {

 ...
 */
class WPGitHubButtons_AdminPageFramework_FieldType_select extends WPGitHubButtons_AdminPageFramework_FieldType {
...
CSSRULES;
    ...
    protected function getField($aField) {
        $_oSelectInput = new WPGitHubButtons_AdminPageFramework_Input_select($aField['attributes']);

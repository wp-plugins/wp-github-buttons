 ...
 */
class WPGitHubButtons_AdminPageFramework_FormTable_Base extends WPGitHubButtons_AdminPageFramework_FormOutput {
    public function __construct($aFieldTypeDefinitions, array $aFieldErrors, $oMsg = null) {
        ...
        $this->oMsg = $oMsg ? $oMsg : WPGitHubButtons_AdminPageFramework_Message::getInstance();
        $this->_loadScripts();
    }
    ...
    private function _loadScripts() {
        ...
        new WPGitHubButtons_AdminPageFramework_Script_Tab;
    }
...
JAVASCRIPTS;
    ...
    protected function _getCollapsibleSectionsEnablerScript() {
        ...
        new WPGitHubButtons_AdminPageFramework_Script_CollapsibleSection($this->oMsg);
    }
    ...
    protected function _getRepeatableSectionsEnablerScript($sContainerTagID, $iSectionCount, $aSettings) {
        ...
        new WPGitHubButtons_AdminPageFramework_Script_RepeatableSection($this->oMsg);
...
JAVASCRIPTS;
    ...
    protected function _getDebugInfo($sFieldsType) {
        ...
        return "<div class='admin-page-framework-info'>" . 'Debug Info: ' . WPGitHubButtons_AdminPageFramework_Registry::NAME . ' ' . WPGitHubButtons_AdminPageFramework_Registry::getVersion() . "</div>";
    }
}
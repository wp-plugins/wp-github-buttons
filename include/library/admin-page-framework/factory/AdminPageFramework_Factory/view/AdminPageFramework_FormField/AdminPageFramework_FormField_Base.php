 ...
 */
abstract class WPGitHubButtons_AdminPageFramework_FormField_Base extends WPGitHubButtons_AdminPageFramework_FormOutput {
    public $aField = array();
    ...
    private function _loadScripts($sFieldsType = '') {
        if ('widget' === $sFieldsType && !self::$_bIsLoadedSScripts_Widget) {
            new WPGitHubButtons_AdminPageFramework_Script_Widget;
        ...
        new WPGitHubButtons_AdminPageFramework_Script_Utility;
        new WPGitHubButtons_AdminPageFramework_Script_OptionStorage;
        new WPGitHubButtons_AdminPageFramework_Script_AttributeUpdator;
        new WPGitHubButtons_AdminPageFramework_Script_RepeatableField($this->oMsg);
        new WPGitHubButtons_AdminPageFramework_Script_Sortable;
        new WPGitHubButtons_AdminPageFramework_Script_RegisterCallback;
    }

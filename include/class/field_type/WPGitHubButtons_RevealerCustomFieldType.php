<?php
if ( class_exists( 'WPGitHubButtons_AdminPageFramework_FieldType' ) && ! class_exists( 'WPGitHubButtons_RevealerCustomFieldType' ) ) :
class WPGitHubButtons_RevealerCustomFieldType extends WPGitHubButtons_AdminPageFramework_FieldType {

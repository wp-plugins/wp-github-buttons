<?php
if ( class_exists( 'WPGitHubButtons_AdminPageFramework_FieldType' ) && ! class_exists( 'WPGitHubButtons_MultiTextCustomFieldType' ) ) :
class WPGitHubButtons_MultiTextCustomFieldType extends WPGitHubButtons_AdminPageFramework_FieldType {
